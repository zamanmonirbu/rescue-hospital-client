...
const About = () => {
    return (
        <div className="section relative pt-10 pb-20 bg-gray-300">
            <h2 className="text-2xl leading-normal m-8 font-bold text-black text-center">About Our Hospital</h2>
            <div className="container xl:max-w-6xl mx-auto px-4 flex flex-wrap items-center">
                ...
                <div className="w-full md:w-1/2 md:pl-8">
                    <span className="text-gray-500 leading-relaxed text-justify">
                        ...
                        At Kolakhet Hospital, we offer a comprehensive range of medical services, including but not limited to:

                        Emergency Care: Our 24/7 emergency department is always ready to provide rapid and life-saving care to those in need.
                    </span>
                    <Link to='/hospital/about/more' className='text-green-600 ml-2'>See more</Link>
                </div>
            </div>
        </div>
    );

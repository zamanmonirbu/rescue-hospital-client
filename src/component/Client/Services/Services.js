...
const DepartmentSection = () => {
  return (
    <div id="departments" className=" section relative pt-20 pb-8 md:pt-16 md:pb-0 bg-gray-200">
      <div className="container xl:max-w-6xl mx-auto px-4">
        ...
        <header className="text-center mx-auto mb-12 lg:px-20">
          ...
          <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 100 60" style={{ margin: '0 auto', height: '35px' }} xmlSpace="preserve">
            {/* SVG paths for the circle and lines */}
          </svg>
        ...
        <div className=" flex flex-wrap flex-row -mx-4 text-center">
          {/* Department 1 */}
          <div className="rounded-xl flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" style={{ visibility: 'visible', animationDuration: '1s', animationName: 'fadeInUp' }}>
            <div className="py-8 px-12 mb-12 rounded-xl bg-gray-50 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
              ...
              <h3 className="text-lg leading-normal mb-2 font-semibold text-black">Cardiology</h3>
              <p className="text-gray-500">Comprehensive cardiac care and treatment.</p>
            </div>
          </div>
          
          {/* Department 2 (Repeat similar structure for other departments) */}
          <div className="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" style={{ visibility: 'visible', animationDuration: '1s', animationName: 'fadeInUp' }}>
            <div className="py-8 px-12 mb-12 rounded-xl bg-gray-50 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
              <div className="inline-block text-gray-900 mb-4">
                {/* Department icon */}
                <svg xmlns="http://www.w3.org/2000/svg" width="2rem" height="2rem" fill="currentColor" className="bi bi-flask" viewBox="0 0 16 16">
              ...
              <h3 className="text-lg leading-normal mb-2 font-semibold text-black">Laboratory</h3>
              <p className="text-gray-500">State-of-the-art diagnostic services.</p>
            </div>
          </div>
          
          {/* Department 3 (Repeat similar structure for other departments) */}
          <div className=" flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" style={{ visibility: 'visible', animationDuration: '1s', animationName: 'fadeInUp' }}>
            <div className="py-8 px-12 mb-12 rounded-xl bg-gray-50 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
              <div className="inline-block text-gray-900 mb-4">
                {/* Department icon */}
                <svg xmlns="http://www.w3.org/2000/svg" width="2rem" height="2rem" fill="currentColor" className="bi bi-stethoscope" viewBox="0 0 16 16">
              ...
              <h3 className="text-lg leading-normal mb-2 font-semibold text-black">Internal Medicine</h3>
              <p className="text-gray-500">Comprehensive care for adults.You are in?</p>
            </div>
          </div>
          <div className="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" style={{ visibility: 'visible', animationDuration: '1s', animationName: 'fadeInUp' }}>
            <div className="py-8 px-12 mb-12 rounded-xl bg-gray-50 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
              <div className="inline-block text-gray-900 mb-4">
                {/* Department icon */}
                <svg xmlns="http://www.w3.org/2000/svg" width="2rem" height="2rem" fill="currentColor" className="bi bi-teeth" viewBox="0 0 16 16">
              ...
              <h3 className="text-lg leading-normal mb-2 font-semibold text-black">Dentistry</h3>
              <p className="text-gray-500">Oral health and dental care services.</p>
            </div>
          </div>
          ...
          <div className="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" style={{ visibility: 'visible', animationDuration: '1s', animationName: 'fadeInUp' }}>
            <div className="py-8 px-12 mb-12 rounded-xl bg-gray-50 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
              <div className="inline-block text-gray-900 mb-4">
                {/* Department icon */}
                <svg xmlns="http://www.w3.org/2000/svg" width="2rem" height="2rem" fill="currentColor" className="bi bi-diagram-2" viewBox="0 0 16 16">
              ...
              <h3 className="text-lg leading-normal mb-2 font-semibold text-black">Radiology</h3>
              <p className="text-gray-500">Imaging and diagnostic services.So for you.</p>
            </div>
          </div>
          ...
          <div className="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" style={{ visibility: 'visible', animationDuration: '1s', animationName: 'fadeInUp' }}>
            <div className="py-8 px-12 mb-12 rounded-xl bg-gray-50 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
              ...
              <h3 className="text-lg leading-normal mb-2 font-semibold text-black">Cardiology</h3>
              <p className="text-gray-500">Heart and cardiovascular care.Heart care.</p>
            </div>
          </div>
        </div>
        {/* end row */}
